...
def ping(host, timeout=1): 
    ...
    #this part of the code gave an endless loop
    #while 1 : 
    #   delay = doOnePing(dest, timeout) 
    #    print(delay) 
...
#Picked IP of different continents from:
#https://www.dotcom-monitor.com/blog/technical-tools/network-location-ip-addresses/
print('\n\n-----------------------')
print("Ping to Chicago, Illinois")
ping("209.142.68.29") #Chicago, Illinois

print('\n\n-----------------------')
print("Ping to Hong Kong, China")
ping("103.1.14.238") #China

print('\n\n-----------------------')
print("Ping to Sydney, Australia")
ping("101.0.86.43") # Sydney, Australia

print('\n\n-----------------------')
print("Ping to Paris, France")
ping("51.158.22.211") #Paris, France
